...
public class NewOrder {
    ...
    public static NewOrder marketSell(String symbol, double quantity) {
        return new NewOrder(symbol, OrderSide.SELL, OrderType.MARKET, null, BigDecimal.valueOf(quantity));
    }
     ...
     */
    public static NewOrder limitBuy(String symbol, TimeInForce timeInForce, double quantity, double price) {
        return new NewOrder(symbol, OrderSide.BUY, OrderType.LIMIT, timeInForce, BigDecimal.valueOf(quantity), BigDecimal.valueOf(price));
    }
     ...
     */
    public static NewOrder limitSell(String symbol, TimeInForce timeInForce, double quantity, double price) {
        return new NewOrder(symbol, OrderSide.SELL, OrderType.LIMIT, timeInForce, BigDecimal.valueOf(quantity), BigDecimal.valueOf(price));
    }
    ...
    public static NewOrder marketBuy(String symbol, BigDecimal quantity, BigDecimal marketMaxAmount) {
        return new NewOrder(symbol, OrderSide.BUY, OrderType.MARKET, null, quantity).marketMaxAmount(marketMaxAmount);
    }
