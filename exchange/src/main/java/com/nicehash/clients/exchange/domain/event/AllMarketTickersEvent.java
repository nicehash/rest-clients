...
public class AllMarketTickersEvent {
  ...
  public long getFirstTradeNumber() {
    return firstTradeNumber;
  }

  public void setFirstTradeNumber(long firstTradeNumber) {
    this.firstTradeNumber = firstTradeNumber;
  }

  public long getLastTradeNumber() {
    return lastTradeNumber;
  }

  public void setLastTradeNumber(long lastTradeNumber) {
    this.lastTradeNumber = lastTradeNumber;
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
        ...
        .append("firstTradeNumber", firstTradeNumber)
        .append("lastTradeNumber", lastTradeNumber)
