...
import com.nicehash.clients.exchange.impl.ExchangeAsyncClientImpl;
import java.util.List;
import java.util.UUID;

/**
 * NiceHash Exchange API façade, supporting asynchronous/non-blocking access NiceHash's Exchange
 * REST API.
 */
...
public interface ExchangeAsyncClient {
  ...
  //     * be sent AND the distance between <code>startTime</code> and <code>endTime</code> must be
  // less than 24 hours.
  //     *
