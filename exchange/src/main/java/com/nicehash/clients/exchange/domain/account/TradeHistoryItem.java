...
public class TradeHistoryItem {
    /**
     * Trade identifier is a combination of UUID (which is actually the corresponding order id)
     * and additional int idNumber (counted from 0 up).
     */
    private UUID id;
    ...
    /**
     * Trade number is unique within a particular market segment (symbol) counted from 0 up -
     * it orders individual trades by their execution in the whole market segment.
     */
