...
/**
 * Custom serializer for an AssetBalance, since the streaming API returns an object in the format
...
public class AssetBalanceSerializer extends JsonSerializer<AssetBalance> {
  ...
  @Override
  public void serialize(AssetBalance value, JsonGenerator gen, SerializerProvider serializers)
      throws IOException {
