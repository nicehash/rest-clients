...
//    List<AggTrade> getAggTrades(String symbol);
     ...
     */
    List<Trade> getMyTrades(String symbol, OrderRelOp relationalOp, Long tradeNumber, Integer limit, SortDirection sortDirection, Long recvWindow, Long timestamp);
