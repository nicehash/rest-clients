...
import static com.nicehash.clients.util.cli.CliUtils.ensureOption;
import static com.nicehash.clients.util.cli.CliUtils.missOption;

import com.nicehash.clients.examples.nhx.util.OrderType;
  ...
  public void execute(String[] args) {
    ...
    if (args == null || args.length == 0) {
      System.out.println(
          "Usage: "
              + cmd
              + " ORDER_TYPE MARKET_SYMBOL [--quantity QUANTITY] [--price PRICE] [--max-amount MAX_AMOUNT]");
      System.out.println();
      ...
      case LIMIT_BUY:
        {
          ...
          System.out.println(
              "Successfully placed a LIMIT BUY order for "
                  + quantity
                  + " "
                  + m.gold()
                  + " at price "
      ...
      case LIMIT_SELL:
        {
          ...
          System.out.println(
              "Successfully placed a LIMIT SELL order for "
                  + quantity
                  + " "
                  + m.gold()
                  + " at price "
      ...
      case MARKET_BUY:
        {
          ...
          if (quantity != null) {
            ...
            System.out.println(
                "Successfully placed a MARKET BUY order for "
                    + quantity
                    + " "
                    + m.gold()
      ...
      case MARKET_SELL:
        {
          ...
          System.out.println(
              "Successfully placed a MARKET SELL order of "
                  + quantity
                  + " "
                  + m.gold()
                  + "\n"
