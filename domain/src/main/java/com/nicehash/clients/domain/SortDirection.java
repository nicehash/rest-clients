...
public enum SortDirection {
   ...
   * {@code T}, and returns a {@code Comparator<T>} that compares by that sort key in this sort
   * direction.
   *
   ...
   */
  public abstract <T, U extends Comparable<? super U>> Comparator<T> comparing(
      Function<? super T, ? extends U> keyExtractor);
}
