...
public enum Currency {
    ...
    @Deprecated ZEC("TZEC", 8, "Zcash", false, 7),
    @Deprecated DASH("TDASH", 8, "Dash", false, 8),
    @Deprecated XLM("TXLM", 7, "Stellar", false, 9),
    @Deprecated EOS("TEOS", 4, "EOS", false, 10),
    @Deprecated USDT("TERC", 6, "Tether", false, 11, Set.of(ETH)),
    @Deprecated BSV("TBSV", 8, "Bitcoin SV", false, 12),
    @Deprecated LINK("TERC", 18, "ChainLink", false, 13, Set.of(ETH)),
    @Deprecated BAT("TERC", 18, "Basic Attention Token", false, 14, Set.of(ETH)),
    @Deprecated PAX("TERC", 18, "Paxos Standard", false, 15, Set.of(ETH)),
    @Deprecated ZRX("TERC", 18, "0x Token", false, 16, Set.of(ETH)),
    @Deprecated HOT("TERC", 18, "Holo Token", false, 17, Set.of(ETH)),
    @Deprecated OMG("TERC", 18, "OmiseGO", false, 18, Set.of(ETH)),
    @Deprecated REP("TERC", 18, "Augur", false, 19, Set.of(ETH)),
    @Deprecated NEXO("TERC", 18, "Nexo Token", false, 20, Set.of(ETH)),
    @Deprecated BTG("TBTG", 8, "Bitcoin Gold", false, 21),
    @Deprecated EURKM("TEURKM", 4, "Euro Kriptomat", false, 82),
    @Deprecated ENJ("TERC", 18, "Enjin", false, 22, Set.of(ETH)),
    @Deprecated MATIC("TERC", 18, "Matic", false, 23, Set.of(ETH)),
    @Deprecated ELF("TERC", 18, "ELF", false, 24, Set.of(ETH)),
    @Deprecated SNT("TERC", 18, "Status", false, 25, Set.of(ETH)),
    @Deprecated BNT("TERC", 18, "Bancor", false, 26, Set.of(ETH)),
    @Deprecated KNC("TERC", 18, "KyberNetwork", false, 27, Set.of(ETH)),
    @Deprecated MTL("TERC", 8, "Metal", false, 28, Set.of(ETH)),
    @Deprecated POLY("TERC", 18, "Polymath", false, 29, Set.of(ETH)),
    @Deprecated POWR("TERC", 6, "PowerLedger", false, 30, Set.of(ETH)),
    @Deprecated GTO("TERC", 5, "Gifto", false, 31, Set.of(ETH)),
    @Deprecated LOOM("TERC", 18, "Loom", false, 32, Set.of(ETH)),
    @Deprecated CVC("TERC", 8, "Civic", false, 33, Set.of(ETH)),
    @Deprecated AST("TERC", 4, "AirSwap", false, 34, Set.of(ETH)),
    @Deprecated PPT("TERC", 8, "Populous", false, 35, Set.of(ETH)),
    @Deprecated LRC("TERC", 18, "Loopring", false, 36, Set.of(ETH)),
    @Deprecated KEY("TERC", 18, "Selfkey", false, 37, Set.of(ETH)),
    @Deprecated STORJ("TERC", 8, "Storj", false, 38, Set.of(ETH)),
    @Deprecated STORM("TERC", 18, "Storm", false, 39, Set.of(ETH)),
    @Deprecated TNT("TERC", 8, "Tierion", false, 40, Set.of(ETH)),
    @Deprecated DATA("TERC", 18, "DATAcoin", false, 41, Set.of(ETH)),
    @Deprecated AOA("TERC", 18, "Aurora", false, 42, Set.of(ETH)),
    @Deprecated RDN("TERC", 18, "Raiden", false, 43, Set.of(ETH)),
    @Deprecated USDC("TERC", 6, "USD Coin", false, 44, Set.of(ETH)),
  	@Deprecated FET("TERC", 18, "Fetch", false, 45, Set.of(ETH)),
    @Deprecated ANT("TERC", 18, "Aragon", false, 46, Set.of(ETH)),
    @Deprecated AERGO("TERC", 18, "Aergo", false, 47, Set.of(ETH)),
    @Deprecated LBA("TERC", 18, "Libra", false, 48, Set.of(ETH)),
    @Deprecated XMR("TXMR", 12, "Monero", false, 49),
    @Deprecated MITH("TERC", 18, "Mithril", false, 50, Set.of(ETH)),
    @Deprecated BAND("TERC", 18, "Band", false, 51, Set.of(ETH)),
    @Deprecated SXP("TERC", 18, "Swipe", false, 52, Set.of(ETH)),
    @Deprecated EURS("TERC", 2, "Stasis EURO", false, 53, Set.of(ETH)),
    @Deprecated WBTC("TERC", 8, "Wrapped BTC", false, 54, Set.of(ETH)),
    RVN("TRVN", 8, "Raven Coin", false, 55),
    @Deprecated UNI("TERC", 18, "Uniswap", false, 56, Set.of(ETH)),
    @Deprecated AAVE("TERC", 18, "Aeve", false, 57, Set.of(ETH)),
    @Deprecated FTM("TERC", 18, "Fantom", false, 58, Set.of(ETH)),
    @Deprecated YFI("TERC", 18, "yearn.finance", false, 59, Set.of(ETH)),
    DOGE("TDOGE", 8, "Dogecoin", false, 60),
    @Deprecated ONEINCH("TERC", 18, "1INCH", false, 61, Set.of(ETH)),
    @Deprecated SUSHI("TERC", 18, "Sushi", false, 62, Set.of(ETH)),
    @Deprecated OCEAN("TERC", 18, "Ocean", false, 63, Set.of(ETH)),
    @Deprecated MKR("TERC", 18, "Maker", false, 64, Set.of(ETH)),
    @Deprecated CRV("TERC", 18, "Curve DAO", false, 65, Set.of(ETH)),
    @Deprecated CHZ("TERC", 18, "chiliZ", false, 66, Set.of(ETH)),
    @Deprecated GRT("TERC", 18, "The Graph", false, 67, Set.of(ETH)),
    @Deprecated GNO("TERC", 18, "Gnosis", false, 68, Set.of(ETH)),
    @Deprecated HBAR("THBAR", 8, "Hedera Hashgraph", false, 69),
    @Deprecated ADA("TADA", 6, "Cardano", false, 70),
    @Deprecated ALGO("TALGO", 6, "Algorand", false, 71),
    @Deprecated XTZ("TXTZ", 6, "Tezos", false, 72),
    @Deprecated SAND("TERC", 18, "Sand", false, 73, Set.of(ETH)),
    @Deprecated SHIB("TERC", 18, "Shiba Inu", false, 74, Set.of(ETH)),
    @Deprecated STX("TSTX", 6, "Stacks", false, 75),
    @Deprecated GALA("TERC", 8, "Gala", false, 76, Set.of(ETH)),
    @Deprecated SOL("TSOL", 9, "Solana", false, 77),
    @Deprecated DOT("TDOT", 10, "Polkadot", false, 78),
    ...
    @Deprecated TZEC("ZEC", 8, "Zcash TestNet", true, 7),
    @Deprecated TDASH("DASH", 8, "Dash TestNet", true, 8),
    @Deprecated TXLM("XLM", 7, "Stellar TestNet", true, 9),
    @Deprecated TEOS("EOS", 4, "EOS TestNet", true, 10),
    @Deprecated TERC("USDT", 0, "ERC TestNet", true, 11, Set.of(TETH)),
